...
public class MongoJNDIUtils implements ObjectFactory {
	...
	public Object getObjectInstance(Object obj, Name name, Context nameCtx,
	    ...
	    mongoTemplate = new MongoTemplate(new MongoClient(host, port), db, new UserCredentials(username, password));
